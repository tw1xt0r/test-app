...
type HandleStyleShorthand = (property: string, options: Record<string, unknown>) => void;
...
export declare function parseLength(length: number | Length | DimensionPercentageFor_LengthValue | NumberOrPercentage | LengthValue, options: ParseDeclarationOptionsWithValueWarning): number | string | RuntimeValue | undefined;
export {};
