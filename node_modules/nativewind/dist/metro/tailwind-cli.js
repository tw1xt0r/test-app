    ...
    try {
        ...
        cli.stderr.on("data", (data) => {
            ...
            if (startedWSServer) {
                ...
                latestStat = stat;
                version = version + 1;
                latestStyleData = JSON.stringify((0, css_to_rn_1.cssToReactNativeRuntime)((0, node_fs_1.readFileSync)(output, "utf-8"), metroConfig.transformer.cssToReactNativeRuntime));
